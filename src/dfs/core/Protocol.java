...
public class Protocol {
	...
	public final static String LIST_TOKEN = "LIST"; // also from ControllerTest and Dstores
	...
	public final static String REMOVE_TOKEN = "REMOVE"; // also from ControllerTest
	
	// messages sent by the ControllerTest
