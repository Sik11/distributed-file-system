 ...
 *  develop other client classes to test your ControllerTest and Dstores thoroughly. You are not expected to include client
...
public class ClientMain {
	...
	public static void main(String[] args) throws Exception{
		...
		if (!downloadFolder.exists())
			if (!downloadFolder.mkdirs()) throw new RuntimeException("Cannot create download folder (folder absolute path: " + downloadFolder.getAbsolutePath() + ")");
